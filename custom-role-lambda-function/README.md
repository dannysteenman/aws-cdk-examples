...
This example is used for the blog post on: https://towardsthecloud.com/aws-cdk-custom-role-lambda-function
...
```bash
cd aws-cdk-examples/custom-role-lambda-function
```
